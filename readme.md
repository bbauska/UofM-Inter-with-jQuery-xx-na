...
-   Write your own javascript code to let a person interact with your
    page.

-   Use existing JavaScript code to improve your page.
...
actually go through your web page and search and find certain elements.
It can add new elements. It can delete other elements from the DOM. So,
think about when you\'re filling out a form on a web page with your
credit card information. There are always these little buttons that you
can click that can say use the same billing address for shipping. Things
like this can make your page much more usable.
...
element, it would have a source, it would have **alt** text, it would
have **width**, and a **style**, different things like that.
...
elements, and attributes, I\'m hoping this slide will make a little bit
...
link. Now this one\'s new, this idea of **element.innerHTML**.
...
2.  While **getElementById** is only used for elements with a specific
    id, you can also return a single element if you use querySelector.
    The
...
class. In that case you will want to use **getElements** (notice the s
at the end) or **querySelectorAll**.
...
then maybe you would prefer the methods that describe the selectors,
e.g. **getElementsByClassName**. Here is an additional (optional)
reading if you would like to learn more about the differences between
...
we call it in this class.

Again, while **getElementsByClassName** doesn\'t need to include that
dot period in your selector, **querySelectorAll** does. You need to be
very specific about exactly what selector you\'re looking for. But it\'s
not really that complicated. Think back to all the code you\'ve been
writing in your CSS. If you can write a selector to style something,
...
When I use **querySelector**, sometimes I forget to include that hashtag
or the period. But to be honest, sometimes when I do **getElementById**,
I love how it\'s mnemonic. I know exactly what I\'m looking for, but
...
notice sometimes when I\'m doing demos in this class, I forget the 's'.
I write **\"getElementByClassName\"**. I liked that some of them have
more descriptive names. I like how others are a little less prone to
typos. My suggestion is you do you, you do it whichever way you prefer.
But don\'t be scared off if you see code online that uses the other
approach. Good luck.
...
hello world. Now you might click on it to prevent this page from
...
wanted you to recognize something right away. When we use
**document.write** alert and prompt we had parenthesis around the side,
here. We don\'t have that anymore. Instead, we use an equal and we just
have it ending with a semicolon. No parenthesis when you\'re using
...
up like it did with **document.write**. Where did it go? Well, it\'s
...
always to right click, **inspect element**, and boom, there it is for
you. If you\'re using Firefox, you want to go to Tools and then Console.
...
we\'ll prompt to the screen.

Next, we can use another variable and say hey, I want you to use this
JavaScript function called date. And date is going to return what the
current date and time is, right now when you\'re looking at the page.
Then you can write that information out. You can even use more from the
...
https://intro-webdesign.com/v3/javascript.html#code
...
<https://d3c33hcgiwev3.cloudfront.net/lai5n737R2KS3omkwxX6Cg_f70762b290f942b5866719357d8838f1_Week-2-Lecture-Slides.pdf?Expires=1701820800&Signature=HuML9ExBqR0-AYoB6OfGf-dhi0CjNzWdT8bfYE~bFNRSmxm6p1wXUGo84c1u~pmGzWPrpMWLoiw6UEIS2gl3AL5hIxkGWjBLBfIkVmhRkpgqIfNntVQ1J2hPh-vssYK50SovXK8kIYnqfSaU61gzZB7Fdhc8eT0UM~hOByETagw_&Key-Pair-Id=APKAJLTNE6QMUY6HBC5A>
...
languages work so well is that they allow people to reuse work that
other people have done. Someone else writes the complex code that can
determine what time it is in any given country? Excellent. If they put
that code in a function then you can use it without really knowing the
details of how it works. (And yes, there is a function for that.)
...
inside here. And how it works is that later, then when people run your
function, it\'ll execute all the code that\'s in **{code you want to
run}.** And this code is just general code you would always write with
your semicolons, your expression, your statements. It\'s just a really
...
When you put your code into different folders you may need to review how
...
Here are the code snippets I will be covering:

-   [JS Events - Basic
    Example](https://codepen.io/ColleenEMc/pen/xwYOXV)

-   [JS Events - Change Style](https://codepen.io/ColleenEMc/pen/BoYLYB)

-   [JS Events - Basic Date
    Example](https://codepen.io/ColleenEMc/pen/bVLwaN)

-   [JS Events - Modify The
    DOM](https://codepen.io/ColleenEMc/pen/vNdXKz)

It also helps to review readings on the material. Begin with the
W3Schools reading on [JavaScript
Events](https://www.w3schools.com/js/js_events.asp) and the official
Mozilla document [Introduction to events - Learn web development \|
...
simply need to grab the demo element by doing
...
In the middle of creating this course I had a \"trip and fall\" accident
where I tripped over my own feet. There will be a number of videos in
the rest of this course where you may notice that my face is
bruised/scarred. I only mention this so that it won\'t distract from
what I hope you will learn.

I appreciate any concern people may have, but I want to assure you that
I am fine. I would appreciate keeping the topic off the discussion
board. The big lesson to take away from this is to avoid carrying five
or six programming books in your backpack, because they can really throw
off your balance.

So, to get us back on track, let me give you the links to the code I am
about to use in the next lesson.

-   [JS - \"this\" first
    example](https://codepen.io/ColleenEMc/pen/yYRxyX)

-   [JS -- "this" second
    example](https://codepen.io/ColleenEMc/pen/KdGBYN)
...
sort of element. Remember, I can call this parameter anything I want. I
can call it element, I can call it e, I can call it elem. It doesn\'t
matter to the computer. As long as it makes sense to you, the general
idea that. Oh, I think I\'m going to be passed a DOM element here.
...
really understood it until I started teaching it. The important thing to
note is that repeated practice helps. You want to go in and you want to
do as much coding as you can. And then, if or when you get stuck,
remember to work backwards. Find that keyword and just start marching
back until you find a tag. As soon as you find that tag, think back.
Think to the early things you learned when you were first learning
HTML5. Think about that DOM and go. Oh, we\'re talking about this little
part of the tree right there. I hope this is something you\'re able to
grasp much more quickly than I did. And I\'m going to do my best to give
...
It is time to work on the Photo Gallery assignment. All of the
components you need to complete this program are in the lessons, it is
your job to put them together. Please note, the answer can be as little
as 4 or 5 lines of code, or much more if that makes more sense to you.
While you are welcome to seek out help on the forums, please remember
that you are not allowed to post code. The code to get you started is
here on CodePen: [JS Gallery
Homework](http://codepen.io/ColleenEMc/pen/wKYxZa)

If you are a keyboard user who does not have access to a mouse, I have
not forgotten about you. Next week we will use JavaScript to add
**tabfocus** to the images to make the site more accessible.

Good luck everyone!

### Instructions

In this assignment you will use the code that I provide in order to
create an interactive photo gallery.  The goal is to gain practice with
writing JavaScript code to update elements of the DOM. You will fill in
the code for two functions -- one to respond to when a mouse is over an
image, and the other to respond to when the mouse leaves an image. 

Your peer review is a learning experience as well since it will allow
you to see how your peer\'s code may differ from yours, while still
achieving the same objectives.

1.  Start by getting your own version of the code.  You can either
    download the file and save it as a JavaScript file or use the
    CodePen example as a start for your own.

2.  Review the HTML and find the ids and classes of the elements you
    want to listen to and/or change.

3.  Begin by filling in the code for the function upDate.

    a.  I highly recommend beginning with a **console.log()** to check
        that your event is triggering.

    b.  I would then recommend that you use console.log to print out
        some information about the previewPic variable, specifically the
        alt and source

    c.  Use **document.querySelector** or **document.getElementById** to
        change the text of the element with the id of **image**.

    d.  Check your work.

    e.  Use **document.querySelector** or **document.getElementById** to
        change the background image of the element with the id of
        **image**.

    f.  Check your work.  If it isn\'t working, use console.log to
        doublecheck the values you are using.

4.  Fill in the code for the undo function.

    a.  Update the url for the background image of the div with the id
        of **image** back to the original value of **background-image:
        url(\'\')**.      

    b.  Update the text of the div with the id of **image** back to the
        original text of \"Hover over an image below to display here.\"

5.  Host and share your site - using either CodePen or a hosting site of
    your choosing.
...
peer who will check the functionality of your JavaScript

-   The code submitted is using the sample code provided by Colleen.
...
I strongly encourage you to check out these readings to help solidify
some of these concepts before you move on to Week 3.  (It might also
help with the end of week quiz.)

-   [JavaScript
    Functions](https://www.w3schools.com/js/js_functions.asp) (This was
    already required reading but I know that sometimes it is easy to
    miss a reading here or there.
...
Finally!! Now is when I start to explain some of the concepts, I said
you had to wait for. Hopefully by now you are comfortable with the code
...
In the lessons ahead I will be showing you how to use JavaScript to
...
-   Have an awareness of data attributes and how they are used to create
...
deeply about what you\'re seeing in other people\'s sites. I hope you
have some fun with this. I hope it\'s something that you are proud of
and that you can share with others, and that you leave this feeling like
